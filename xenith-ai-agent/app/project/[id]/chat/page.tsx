        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="font-semibold text-gray-900">{projectInfo.name}</h1>
                  ...
                  {message.type === "user" ? (
                    ...
                    <div className="space-y-6">
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className="space-y-6">
                            {message.content.keyInsights.map((insight: any, index: number) => (
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <ul className="space-y-3">
                            {message.content.executiveSummary.map((point: string, index: number) => (
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            {message.content.supportingCharts.map((chart: any) => (
